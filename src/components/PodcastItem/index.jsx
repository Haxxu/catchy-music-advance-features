...
const PodcastItem = ({ type = 'default', podcast, to }) => {
    ...
    const handlePlayTrack = async () => {
        playTrack(dispatch, podcast.firstTrack).catch(console.error);
                    ...
                    <Link className={cx('album-link')} to={to}>
                        <div className={cx('album')}>
                            ...
                            <div className={cx('info')}>
                                <p className={cx('name')}>{podcast?.name}</p>
                            </div>
                        </div>
                    </Link>
                    {context?.contextType === 'podcast' && context?.contextId === podcast._id ? (
                        <IconButton
                ...
                >
                    ...
                    <div className={cx('info')}>
                        ...
                        <div className={cx('detail')}>
                            {/* <div className={cx('description')}>{podcast?.description}</div> */}
                            <Link className={cx('artist')} to={`/podcaster/${podcast?.owner?._id}`}>
                                {podcast?.owner?.name}
                            </Link>
                        </div>
                    </div>
